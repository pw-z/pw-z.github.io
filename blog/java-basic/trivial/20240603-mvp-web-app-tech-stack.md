...
*Posted on 2024.06.03 by [Pengwei](http://pwz.wiki) under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)* 

*文章主体信息使用大模型生成，辅助自己回顾相关知识点，注意甄别信息准确性*

目前为止设计实现一个原型应用的基本环节如下：
