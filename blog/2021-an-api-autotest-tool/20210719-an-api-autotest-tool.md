...
*Posted on 2021.07.19 by [Pengwei](http://pwz.wiki) under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)* 
...
- [An API Autotest Tool Part2: Generate Test Report from Scratch](#an-api-autotest-tool-part2-generate-test-report-from-scratch)
  ...
  - [5 Generate Report](#5-generate-report)
    - [5.1 Paratemeters (test_summary_dict & case_detail_list) from run_test.py](#51-paratemeters-test_summary_dict--case_detail_list-from-run_testpy)
    - [5.2 Main Method: generate_report(test_summary_dict, case_detail_list)](#52-main-method-generate_reporttest_summary_dict-case_detail_list)
    - [5.3 Sub Method 1: generate_html_body(test_summary_dict, case_detail_list)](#53-sub-method-1-generate_html_bodytest_summary_dict-case_detail_list)
    - [5.4 Sub Method 2: generate_html_summary(test_summary_dict)](#54-sub-method-2-generate_html_summarytest_summary_dict)
