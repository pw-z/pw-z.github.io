...
*2020032801-the-illustrated-guide-to-a-phd-in-chinese-with-picture-in-css*  
*Posted on 2020.03.29 by [Pengwei Zhang](http://pwz.wiki) under [**CC BY-NC 2.5**](http://creativecommons.org/licenses/by-nc/2.5/)*  
*本文译自 [Matt Might](http://matt.might.net/) - [The illustrated guide to a Ph.D.](http://matt.might.net/articles/phd-school-in-pictures/)*  
*本文所有图片使用原生CSS绘制*


* [何为博士（译The illustrated guide to a Ph\.D\.）](#%E4%BD%95%E4%B8%BA%E5%8D%9A%E5%A3%AB%E8%AF%91the-illustrated-guide-to-a-phd)
...
这篇短文出自Matthew Might的博客，文中用一组恰到好处的图片描述了“读书人”的求知之路，几年前迷茫间偶然读到，深受鼓励，一直存在书签里。近来诸事不顺，又翻出这篇短文，自己译一版，权当散心，顺便勉励自己。

有关Matthew Might，贴一段维基百科上的介绍，括号里的中文是我添的：

> Matthew Might is the director of the Hugh Kaul Personalized Medicine Institute at the University of Alabama Birmingham(阿拉巴马大学伯明翰分校).
> 
> Might received his bachelors in 2001 and PhD in 2007 from Georgia Tech(乔治亚理工大学), both in computer science. In 2008, he joined the faculty at the University of Utah, where he worked as a professor of computer science and pharmaceutical chemistry until 2017. He was a visiting professor of biomedical informatics at Harvard Medical School(哈佛医学院).
> 
> Might is a White House strategist for the Precision Medicine Initiative(奥巴马提出的精准医学计划), and is an advisor for the Undiagnosed Diseases Network(美国国立卫生研究院的“未诊断疾病网络”项目). In 2017, he was given a Rare Impact Award by the National Organization for Rare Disorders.


*出于某种偏执，这个博客里尽量**不**使用外挂图片，无论是链接形式的还是子文件夹形式的（一篇文章最好就是一个独立的文件）。本文中的图是我用CSS写出来之后嵌入到MarkDown里的，图形比较简单的情况下这是一个不错的解决方案，文末给出了具体的代码及注释。*
...
这篇文档原文有版权声明，用的是CC BY-NC 2.5协议，与我常用的BY-SA不同，这里附上原文中的版权声明：
